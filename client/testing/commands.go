...
import (
	...
	"github.com/Edge-Center/edgecentercloud-go/cmd"
...
func MetadataTest(getMetadata FuncGetMetadata, a *cli.App, resourceName string, resourceID string) error {
	...
	args := []string{"edgeclient", resourceName, "metadata", "create", "-m", "key1=val1", "-m", "key2=val2", resourceID}
	err := a.Run(args)
	if err != nil {
		return err
	}
	...
	args = []string{"edgeclient", resourceName, "metadata", "list", "-t", resourceID}
	err = a.Run(args)
	if err != nil {
		return err
	}
	...
	a.Writer = new(bytes.Buffer)
	args = []string{"edgeclient", resourceName, "metadata", "show", "-t", "-m", "key1", resourceID}
	err = a.Run(args)
	if err != nil {
		return err
	}
	...
	args = []string{"edgeclient", resourceName, "metadata", "update", "-m", "key1=val11", "-m", "key4=val4", resourceID}
	err = a.Run(args)
	if err != nil {
		return err
	}
	...
	args = []string{"edgeclient", resourceName, "metadata", "replace", "-m", "key1=val11", "-m", "key4=val4", resourceID}
	err = a.Run(args)
	if err != nil {
		return err
	}
