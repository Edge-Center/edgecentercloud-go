...
func Update(c *edgecloud.ServiceClient, stackID string, opts UpdateOptsBuilder) (r UpdateResult) {
...
func UpdatePatch(c *edgecloud.ServiceClient, stackID string, opts UpdatePatchOptsBuilder) (r UpdateResult) {
...
func Delete(c *edgecloud.ServiceClient, stackID string) (r DeleteResult) {
