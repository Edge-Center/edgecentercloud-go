...
func (opts MarkUnhealthyOpts) ToMarkUnhealthyMap() (map[string]interface{}, error) {
	b, err := edgecloud.BuildRequestBody(opts, "")
	if err != nil {
		return nil, err
	}
	return b, nil
...
func MarkUnhealthy(c *edgecloud.ServiceClient, stackID, resourceName string, opts MarkUnhealthyOptsBuilder) (r MarkUnhealthyResult) {
...
// List resources.
func List(c *edgecloud.ServiceClient, stackID string, opts ListOptsBuilder) pagination.Pager {
...
func Get(c *edgecloud.ServiceClient, stackID, resourceName string) (r GetResult) {
...
func ListAll(client *edgecloud.ServiceClient, stackID string, opts ListOptsBuilder) ([]ResourceList, error) {
