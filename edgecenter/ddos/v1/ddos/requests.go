...
func GetAccessibility(c *edgecloud.ServiceClient) (r GetAccessStatusResult) {
...
func CheckRegionCoverage(c *edgecloud.ServiceClient) (r CheckRegionCoverageResult) {
	url := checkRegionCoverageURL(c)
	_, r.Err = c.Get(url, &r.Body, nil)
	return
}

func ListProfileTemplates(c *edgecloud.ServiceClient) pagination.Pager {
...
func ListProfiles(c *edgecloud.ServiceClient) pagination.Pager {
...
func ListAllProfileTemplates(c *edgecloud.ServiceClient) ([]ProfileTemplate, error) {
...
func ListAllProfiles(c *edgecloud.ServiceClient) ([]Profile, error) {
...
func CreateProfile(c *edgecloud.ServiceClient, opts CreateProfileOptsBuilder) (r tasks.Result) {
...
func UpdateProfile(c *edgecloud.ServiceClient, id int, opts UpdateProfileOptsBuilder) (r tasks.Result) {
...
func DeleteProfile(c *edgecloud.ServiceClient, profileID int) (r tasks.Result) {
	_, r.Err = c.DeleteWithResponse(deleteProfileURL(c, profileID), &r.Body, nil)
	return
}

func ActivateProfile(c *edgecloud.ServiceClient, id int, opts ActivateProfileOptsBuilder) (r tasks.Result) {
