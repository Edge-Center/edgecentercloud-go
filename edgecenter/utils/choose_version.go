...
func ChooseVersion(client *edgecloud.ProviderClient, recognized []*Version) (*Version, string, error) {
	...
	var resp response
	_, err := client.Request("GET", client.IdentityBase, &edgecloud.RequestOpts{
		JSONResponse: &resp,
		OkCodes:      []int{200, 300},
	})
	if err != nil {
