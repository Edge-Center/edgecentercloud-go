...
func ListAll(c *edgecloud.ServiceClient, opts ListOptsBuilder) ([]ReservedFixedIP, error) {
...
func Delete(c *edgecloud.ServiceClient, id string) (r tasks.Result) {
...
func ListConnectedDevice(c *edgecloud.ServiceClient, id string) pagination.Pager {
...
func ListAllConnectedDevice(c *edgecloud.ServiceClient, id string) ([]Device, error) {
...
func ListAvailableDevice(c *edgecloud.ServiceClient, id string) pagination.Pager {
...
func ListAllAvailableDevice(c *edgecloud.ServiceClient, id string) ([]Device, error) {
...
func SwitchVIP(c *edgecloud.ServiceClient, id string, opts SwitchVIPOptsBuilder) (r GetResult) {
...
func AddPortsToShareVIP(c *edgecloud.ServiceClient, id string, opts PortsToShareVIPOptsBuilder) (r SliceResult) {
...
func ReplacePortsToShareVIP(c *edgecloud.ServiceClient, id string, opts PortsToShareVIPOptsBuilder) (r SliceResult) {
	b, err := opts.ToPortsToShareVIPOptsMap()
	if err != nil {
		r.Err = err
		return
	...
	_, r.Err = c.Put(portsToShareVIPURL(c, id), b, &r.Body, &edgecloud.RequestOpts{OkCodes: []int{200}})
	return
}
