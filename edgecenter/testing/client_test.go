...
func TestAuthenticatedClient(t *testing.T) {
	...
	options := edgecloud.AuthOptions{
		...
		Password: "secret",
		APIURL:   th.Endpoint(),
		AuthURL:  th.ECRefreshTokenIdentifyEndpoint(),
	}
	provider, err := edgecenter.AuthenticatedClient(options)
...
func TestServiceClientURL(t *testing.T) {
	...
	c, err := edgecenter.TokenClientService(edgecloud.TokenOptions{
		APIURL:       "http://test.com/",
		AccessToken:  "1",
		RefreshToken: "1",
		AllowReauth:  false,
	}, edgecloud.EndpointOpts{
		Type:    "test",
		Name:    "test",
		Region:  0,
		Project: 0,
