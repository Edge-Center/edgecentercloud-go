...
func (opts InstanceOperationOpts) ToVolumeInstanceOperationMap() (map[string]interface{}, error) {
	if err := edgecloud.TranslateValidationError(edgecloud.Validate.Struct(opts)); err != nil {
		return nil, err
	}
	return edgecloud.BuildRequestBody(opts, "")
}
...
func Attach(c *edgecloud.ServiceClient, volumeID string, opts InstanceOperationOptsBuilder) (r UpdateResult) {
...
func Detach(c *edgecloud.ServiceClient, volumeID string, opts InstanceOperationOptsBuilder) (r UpdateResult) {
	b, err := opts.ToVolumeInstanceOperationMap()
	if err != nil {
		r.Err = err
		return
...
func Retype(c *edgecloud.ServiceClient, volumeID string, opts PropertiesOperationOptsBuilder) (r UpdateResult) {
...
func Extend(c *edgecloud.ServiceClient, volumeID string, opts PropertiesOperationOptsBuilder) (r tasks.Result) {
	b, err := opts.ToVolumePropertiesOperationMap()
	if err != nil {
		r.Err = err
		return
